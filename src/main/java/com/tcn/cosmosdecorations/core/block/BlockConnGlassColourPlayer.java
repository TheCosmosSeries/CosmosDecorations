...
public class BlockConnGlassColourPlayer extends BlockConnGlassColour {

	private final boolean collidePlayers;
	
	public BlockConnGlassColourPlayer(Properties propertiesIn, boolean collidePlayersIn, int blockColourIn) {
